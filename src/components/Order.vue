...
async function handleOrder() {
    ...
    const success = submitOrder(orderFormStore, accessoriesStore, casesSelectsStore, terminalsSelectsStore, inputsSelectsStore, orientationStore); // Обновляеи данные в сторе
    success ? showAlert('Запрос отправлен', 'alert--success') : null
}
